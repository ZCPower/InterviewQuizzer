    ...
    return (
        ...
        items-center'>
            ...
            <form id='regForm' onSubmit={handleLoginSubmit} className='h-1/2 w-2/3 xl:w-1/2 flex flex-col items-center bg-gray justify-between rounded-2xl '>
                <div className='bg-white text-midOrange font-quicksand text-xl md:text-2xl 2xl:text-3xl w-full h-1/6 text-center flex justify-center items-center rounded-t-2xl'><h2 >Login</h2>
                </div>
                ...
                <div className='mb-4 md:mb-10 text-center flex flex-col gap-4'>
                    ...
                    <p className='text-base'>Don't have an account? Register here!</p>
                </div>
            </form>
        </div >
    )
